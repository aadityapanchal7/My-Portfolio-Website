...
function Lander() {
  return (
    <div className='flex flex-col min-h-screen leading-relaxed text-black md:box-border md:w-1/2 items-start md:pl-20 pl-14 mt-5 md:mt-0 md:fixed justify-center'>
